  ...
  return (
    <div className="llp-root">
        ...
        <div className="llp-left">
          <div className="llp-left-content">
            <div className="llp-logo-row">
              <div className="llp-logo-icon">
                <svg width="28" height="28" viewBox="0 0 36 36" fill="none">
                  <rect width="36" height="36" rx="10" fill="url(#llpSecGrad)"/>
                  <path d="M9 26L18 10L27 26H9Z" fill="white" fillOpacity="0.95"/>
                  <rect x="15" y="20" width="6" height="6" rx="2" fill="url(#llpSecGrad)"/>
                  <defs>
                    <linearGradient id="llpSecGrad" x1="0" y1="0" x2="36" y2="36" gradientUnits="userSpaceOnUse">
            ...
            <div className="llp-left-headline">
              ...
              <h1 className="llp-h1">Welcome to<br /><span className="llp-h1-gold">Campus One</span></h1>
              <p className="llp-left-desc">A unified digital ecosystem connecting every member of the Jeppiaar Institute community.</p>
            </div>

            <div className="llp-trust-list">
              {['Secure Authentication', 'Campus Authorized Access', 'Protected Student Data'].map((t) => (
                <div className="llp-trust-item" key={t}>
            ...
            <div className="llp-stats-strip">
              {[{ v: '1000+', l: 'Students' }, { v: '50+', l: 'Faculty' }, { v: '8', l: 'Departments' }].map((s) => (
          ...
          <div className="llp-card">
            ...
            <div className="llp-card-header">
              <div className="llp-role-badge">
                <div className="llp-role-icon security-icon">
                  <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/>
                  </svg>
                </div>
              </div>
              <h2 className="llp-card-title">Security Login</h2>
              <p className="llp-card-sub">Enter your security credentials to access the portal</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="llp-form">
              <div className="llp-field">
                <div className="llp-input-wrap">
                  ...
                  <input type="text" id="username" className="llp-input" placeholder=" " required value={email} onChange={(e) => setEmail(e.target.value)} autoComplete="email" />
                  <label className="llp-label" htmlFor="username">Security Email / ID</label>
                </div>
              </div>
              ...
              <div className="llp-field">
                <div className="llp-input-wrap">
                  ...
                  <input type={showPassword ? "text" : "password"} id="password" className="llp-input" placeholder=" " required value={password} onChange={(e) => setPassword(e.target.value)} autoComplete="current-password" />
                  <label className="llp-label" htmlFor="password">Password</label>
                  <button type="button" className="llp-eye-btn" onClick={() => setShowPassword(!showPassword)} title={showPassword ? "Hide" : "Show"}>
                    {showPassword ? (
              ...
              <button type="submit" className="llp-submit-btn" disabled={Loading} id="security-submit-btn">
                {Loading ? (<><span className="llp-spinner" /><span>Signing in...</span></>) : (<><span>Sign In</span><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M5 12h14M12 5l7 7-7 7"/></svg></>)}
              </button>
            </form>

            <div className="llp-security-row">
              <div className="llp-security-item"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#059669" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg><span>SSL Encrypted</span></div>
              <div className="llp-security-item"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#059669" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg><span>Verified Platform</span></div>
              <div className="llp-security-item"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#059669" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="11" width="18" height="11" rx="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg><span>Data Protected</span></div>
            </div>
          </div>
      ...
      <style>{`
        ...
        .llp-root{font-family:'Inter',-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;min-height:100vh;position:relative;overflow:hidden;-webkit-font-smoothing:antialiased}
        ...
        .security-icon{background:linear-gradient(135deg,#DC2626,#B91C1C);box-shadow:0 8px 24px rgba(220,38,38,0.35),0 0 0 6px rgba(220,38,38,0.1)}
        ...
        @media(max-width:900px){.llp-split{grid-template-columns:1fr}.llp-left{display:none}.llp-right{padding:32px 24px;min-height:100vh;justify-content:flex-start;padding-top:48px}.llp-back-btn{align-self:flex-start}.llp-card{max-width:100%}}
        @media(max-width:480px){.llp-right{padding:24px 16px}.llp-card{padding:32px 24px 28px;border-radius:20px}.llp-card-title{font-size:22px}.llp-input{height:52px}.llp-submit-btn{height:52px}.llp-security-row{gap:12px}}
      `}</style>
    </div>
  );
};
