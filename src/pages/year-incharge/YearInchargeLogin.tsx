  ...
  return (
    <div className="llp-root">
            ...
            <div className="llp-logo-row">
              <div className="llp-logo-icon">
                <svg width="28" height="28" viewBox="0 0 36 36" fill="none">
                  <rect width="36" height="36" rx="10" fill="url(#llpYIGrad)"/>
                  <path d="M9 26L18 10L27 26H9Z" fill="white" fillOpacity="0.95"/>
                  <rect x="15" y="20" width="6" height="6" rx="2" fill="url(#llpYIGrad)"/>
                  <defs>
                    <linearGradient id="llpYIGrad" x1="0" y1="0" x2="36" y2="36" gradientUnits="userSpaceOnUse">
          ...
          <div className="llp-card">
            ...
            <div className="llp-card-header">
              <div className="llp-role-badge">
                <div className="llp-role-icon yi-icon">
              ...
              <h2 className="llp-card-title">Year Incharge Login</h2>
              <p className="llp-card-sub">Enter credentials to access the administrative dashboard</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="llp-form">
              <div className="llp-field">
                <div className="llp-input-wrap">
                  ...
                  <label className="llp-label" htmlFor="username">Email ID</label>
                </div>
              </div>
              ...
              <button type="submit" className="llp-submit-btn" disabled={Loading} id="yi-submit-btn">
      ...
      <style>{`
        ...
        .yi-icon{background:linear-gradient(135deg,#D97706,#B45309);box-shadow:0 8px 24px rgba(217,119,6,0.35),0 0 0 6px rgba(217,119,6,0.1)}
